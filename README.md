Copied from https://github.com/awangdev/LintCode
...
|[1161. Maximum Level Sum of a Binary Tree.java](java/1161.Maximum_Level_Sum_of_a_Binary_Tree.java) [py](java/1161.Maximum_Level_Sum_of_a_Binary_Tree.py)|Medium|[BFS, DFS, Graph]|
...
|[158. Read N Characters Given Read4 II - Call multiple times.java](java/0158.Read_N_Characters_Given_Read4_II_-_Call_multiple_times.java) [py](java/0158.Read_N_Characters_Given_Read4_II_-_Call_multiple_times.py)|Hard|[Enumeration, String]|
...
|[239. Sliding Window Maximum.java](java/0239.Sliding_Window_Maximum.java) [py](java/0239.Sliding_Window_Maximum.py)|Hard|[Deque, Heap, Sliding Window]|
...
|[307. Range Sum Query - Mutable.java](java/0307.Range_Sum_Query_-_Mutable.java) [py](java/0307.Range_Sum_Query_-_Mutable.py)|Medium|[Binary Indexed Tree, Segment Tree]|
...
|[405. Convert a Number to Hexadecimal.java](java/0405.Convert_a_Number_to_Hexadecimal.java) [py](java/0405.Convert_a_Number_to_Hexadecimal.py)|**Easy**|[Bit Manipulation]|
...
|[55. Jump Game.java](java/0055.Jump_Game.java) [py](java/0055.Jump_Game.py)|Medium|[Array, DP, Greedy]|
...
|[724. Find Pivot Index.java](java/0724.Find_Pivot_Index.java) [py](java/0724.Find_Pivot_Index.py)|**Easy**|[Array, PreSum]|
...
|[94. Binary Tree Inorder Traversal.java](java/0094.Binary_Tree_Inorder_Traversal.java) [py](java/0094.Binary_Tree_Inorder_Traversal.py)|**Easy**|[Hash Table, Stack, Tree]|
...
|[ColorGrid.java](java/ColorGrid.java) [py](java/ColorGrid.py)|Medium|[Design, Hash Table]|
...
|[Fast Power.java](java/Fast_Power.java) [py](java/Fast_Power.py)|Medium|[DFS, Divide and Conquer]|
...
|[Jump Game II.java](java/Jump_Game_II.java) [py](java/Jump_Game_II.py)|Hard|[Array, Coordinate DP, DP, Greedy]|
...
|[Longest Increasing Path in a Matrix.java](java/Longest_Increasing_Path_in_a_Matrix.java) [py](java/Longest_Increasing_Path_in_a_Matrix.py)|Hard|[Coordinate DP, DFS, DP, Memoization, Topological Sort]|
...
|[O(1) Check Power of 2.java](java/O(1)_Check_Power_of_2.java) [py](java/O(1)_Check_Power_of_2.py)|**Easy**|[Bit Manipulation]|
...
|[Remove Node in Binary Search Tree.java](java/Remove_Node_in_Binary_Search_Tree.java) [py](java/Remove_Node_in_Binary_Search_Tree.py)|Hard|[BST]|
...
|[Subarray Sum Closest.java](java/Subarray_Sum_Closest.java) [py](java/Subarray_Sum_Closest.py)|Medium|[PreSum, PriorityQueue, Sort, Subarray]|
...
|[The Spiral Matrix II.java](java/The_Spiral_Matrix_II.java) [py](java/The_Spiral_Matrix_II.py)|Medium|[Array]|
|[[tool]. Hash Function.java](java/[tool].Hash_Function.java) [py](java/[tool].Hash_Function.py)|**Easy**|[Hash Table, Lint]|
|[[tool]. MergeSort.java](java/[tool].MergeSort.java) [py](java/[tool].MergeSort.py)|Medium|[Lint, Merge Sort, Sort]|
|[[tool] Quick Select - Median.java](java/[tool]_Quick_Select_-_Median.java) [py](java/[tool]_Quick_Select_-_Median.py)|**Easy**|[Array, Lint, Quick Select, Quick Sort, Two Pointers]|
|[[tool]. Topological Sorting.java](java/[tool].Topological_Sorting.java) [py](java/[tool].Topological_Sorting.py)|Medium|[BFS, DFS, Lint, Topological Sort]|
|[[tool]. UnionFind.java](java/[tool].UnionFind.java) [py](java/[tool].UnionFind.py)|Medium|[Lint, Union Find]|
|[Total Hamming Distance.java](java/Total_Hamming_Distance.java) [py](java/Total_Hamming_Distance.py)|Medium|[Bit Manipulation]|
|[Total Occurrence of Target.java](java/Total_Occurrence_of_Target.java) [py](java/Total_Occurrence_of_Target.py)|Medium|[]|
|[Trailing Zeros.java](java/Trailing_Zeros.java) [py](java/Trailing_Zeros.py)|**Easy**|[Math]|
|[Trapping Rain Water II.java](java/Trapping_Rain_Water_II.java) [py](java/Trapping_Rain_Water_II.py)|Hard|[BFS, Heap, MinHeap, PriorityQueue]|
|[Triangle Count.java](java/Triangle_Count.java) [py](java/Triangle_Count.py)|Medium|[Array]|
|[Triangles.java](java/Triangles.java) [py](java/Triangles.py)|Medium|[Array, Coordinate DP, DFS, DP, Memoization]|
|[Trim a Binary Search Tree.java](java/Trim_a_Binary_Search_Tree.java) [py](java/Trim_a_Binary_Search_Tree.py)|**Easy**|[BST, Tree]|
|[Tweaked Identical Binary Tree.java](java/Tweaked_Identical_Binary_Tree.java) [py](java/Tweaked_Identical_Binary_Tree.py)|**Easy**|[DFS, Tree]|
|[Two Lists Sum.java](java/Two_Lists_Sum.java) [py](java/Two_Lists_Sum.py)|Medium|[Linked List]|
|[Two Strings Are Anagrams.java](java/Two_Strings_Are_Anagrams.java) [py](java/Two_Strings_Are_Anagrams.py)|**Easy**|[]|
|[Two Sum II - Input array is sorted.java](java/Two_Sum_II_-_Input_array_is_sorted.java) [py](java/Two_Sum_II_-_Input_array_is_sorted.py)|Medium|[Array, Binary Search, Two Pointers]|
|[Two Sum IV - Input is a BST.java](java/Two_Sum_IV_-_Input_is_a_BST.java) [py](java/Two_Sum_IV_-_Input_is_a_BST.py)|**Easy**|[Tree]|
|[Ugly Number II.java](java/Ugly_Number_II.java) [py](java/Ugly_Number_II.py)|Medium|[DP, Enumeration, Heap, Math, PriorityQueue]|
|[Ugly Number.java](java/Ugly_Number.java) [py](java/Ugly_Number.py)|Medium|[Math]|
|[Unique Binary Search Tree II.java](java/Unique_Binary_Search_Tree_II.java) [py](java/Unique_Binary_Search_Tree_II.py)|Medium|[BST, DP, Divide and Conquer, Tree]|
|[Unique Binary Search Tree.java](java/Unique_Binary_Search_Tree.java) [py](java/Unique_Binary_Search_Tree.py)|Medium|[BST, DP, Tree]|
|[Unique Word Abbreviation.java](java/Unique_Word_Abbreviation.java) [py](java/Unique_Word_Abbreviation.py)|Medium|[Design, Hash Table]|
|[Update Bits.java](java/Update_Bits.java) [py](java/Update_Bits.py)|Medium|[Bit Manipulation]|
|[Walls and Gates.java](java/Walls_and_Gates.java) [py](java/Walls_and_Gates.py)|Medium|[BFS, DFS]|
|[Wiggle Sort.java](java/Wiggle_Sort.java) [py](java/Wiggle_Sort.py)|Medium|[Array, Sort]|
|[Wildcard Matching.java](java/Wildcard_Matching.java) [py](java/Wildcard_Matching.py)|Hard|[Backtracking, DP, Double Sequence DP, Greedy, Sequence DP, String]|
|[Wood Cut.java](java/Wood_Cut.java) [py](java/Wood_Cut.py)|Medium|[Binary Search]|
|[Word Ladder II.java](java/Word_Ladder_II.java) [py](java/Word_Ladder_II.py)|Hard|[Array, BFS, Backtracking, DFS, Hash Table, String]|
|[Word Ladder.java](java/Word_Ladder.java) [py](java/Word_Ladder.py)|Medium|[BFS]|
|[Word Pattern.java](java/Word_Pattern.java) [py](java/Word_Pattern.py)|**Easy**|[]|
|[Word Search II.java](java/Word_Search_II.java) [py](java/Word_Search_II.py)|Hard|[Backtracking, DFS, Trie]|
|[Word Search.java](java/Word_Search.java) [py](java/Word_Search.py)|Medium|[Array, Backtracking, DFS]|
|[Word Squares.java](java/Word_Squares.java) [py](java/Word_Squares.py)|Hard|[Backtracking, Trie]|
|[Zigzag Iterator.java](java/Zigzag_Iterator.java) [py](java/Zigzag_Iterator.py)|Medium|[BST]|
